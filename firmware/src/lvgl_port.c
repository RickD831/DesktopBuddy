/* Display + touch port for Waveshare ESP32-S3-Touch-LCD-3.49.
 * Adapted from the vendor LVGL v9 demo (waveshareteam/ESP32-S3-Touch-LCD-3.49);
 * QSPI panel setup, chunked DMA flush and touch protocol are kept as-is. */
